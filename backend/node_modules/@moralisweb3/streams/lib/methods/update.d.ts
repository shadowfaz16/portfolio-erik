import { UpdateStreamEvmRequest } from '@moralisweb3/common-streams-utils';
...
export declare const makeUpdateStream: (core: Core, baseUrl: string) => ({ networkType, ...options }: UpdateStreamOptions) => Promise<import("@moralisweb3/common-core").ResponseAdapter<import("@moralisweb3/common-streams-utils").EvmStream, {
    webhookUrl: string;
    description: string;
    tag: string;
