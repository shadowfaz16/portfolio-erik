...
import { UpdateStreamStatusEvmRequest } from '@moralisweb3/common-streams-utils';
...
export declare const makeUpdateStreamStatus: (core: Core, baseUrl: string) => ({ networkType, ...options }: UpdateStreamStatusOptions) => Promise<import("@moralisweb3/common-core").ResponseAdapter<{
    webhookUrl: string;
    description: string;
    tag: string;
...
//# sourceMappingURL=updateStatus.d.ts.map