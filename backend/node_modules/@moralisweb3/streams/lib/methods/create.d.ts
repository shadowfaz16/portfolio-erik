...
import { CreateStreamEvmRequest } from '@moralisweb3/common-streams-utils';
...
export declare const makeCreateStream: (core: Core, baseUrl: string) => ({ networkType, ...options }: CreateStreamOptions) => Promise<import("@moralisweb3/common-core").ResponseAdapter<import("@moralisweb3/common-streams-utils").EvmStream, {
    webhookUrl: string;
    description: string;
    tag: string;
