...
import { DeleteStreamEvmRequest } from '@moralisweb3/common-streams-utils';
...
export declare const makeDeleteStream: (core: Core, baseUrl: string) => ({ networkType, ...options }: DeleteStreamOptions) => Promise<import("@moralisweb3/common-core").ResponseAdapter<import("@moralisweb3/common-streams-utils").EvmStream, {
    webhookUrl: string;
    description: string;
    tag: string;
