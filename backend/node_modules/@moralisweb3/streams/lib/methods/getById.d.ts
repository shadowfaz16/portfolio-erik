...
import { GetStreamEvmRequest } from '@moralisweb3/common-streams-utils';
...
export declare const makeGetStreamById: (core: Core, baseUrl: string) => ({ networkType, network, ...options }: GetStreamOptions) => Promise<import("@moralisweb3/common-core").ResponseAdapter<import("@moralisweb3/common-streams-utils").EvmStream, {
    webhookUrl: string;
    description: string;
    tag: string;
